...
<figure style="width: 50%; max-width: 100%; margin: 0 auto; text-align: center;">
  <img src="../../images/em_1.png" alt="em_1">
  <figcaption>Optimal choice for Q distribution at E-step in EM makes the lower bound touch the log likelihood function (1-d representation for simplicity)</figcaption>
</figure>
<br>
