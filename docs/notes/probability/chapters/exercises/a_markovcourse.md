...
2\. Here we have to calculate the probability of absortion into state 15. Let $a_{i}$ denote the probability of absorption into state 15 from state $i$. Then, $a_{15} = 1$ and $a_{9} = 0$. Using equations from [section](../markov_process/absorption.md),
...
3\. Let $\mu_{i}$ denote the expected number of steps to get absorbed starting from state $i$. Then, $\mu_{15} = \mu_{9} = 0$. Using equations from [section](../markov_process/absorption.md),
...
We can write equations similar to [section](../markov_process/absorption.md) for calculating the expected number of steps with the adjusted transition probabilities
...
We then use equations from [section](../markov_process/absorption.md) to calculate the expected values
