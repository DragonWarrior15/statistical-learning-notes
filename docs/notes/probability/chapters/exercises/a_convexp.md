...
$$
\begin{aligned}
    p_{X+Y}(x) = \int_{-\infty}^{\infty} p_{X}(x-y) \times p_{Y}(y) dy\end{aligned}
$$
...
$$
\begin{aligned}
    p_{X+Y}(x) = \int_{-\infty}^{0} p_{X}(x-y) \times p_{Y}(y) dy + \int_{0}^{x} p_{X}(x-y) \times p_{Y}(y) dy + \int_{x}^{\infty} p_{X}(x-y) \times p_{Y}(y) dy\end{aligned}
$$
...
\begin{aligned}
    ...
    &= \frac{\lambda \mu}{\lambda - \mu}(\exp(\mu x) - \exp(-\lambda x))\end{aligned}
$$
