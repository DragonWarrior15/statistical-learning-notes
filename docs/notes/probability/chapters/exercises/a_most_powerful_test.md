...
The most powerful test will follow the [Neyman-Pearson Lemma](../hypothesis_testing/mean_normal.md#neyman-pearson-lemma). To apply that, we need to first calculate the likelihood ratio of the five observed values under the two hypothesis.
