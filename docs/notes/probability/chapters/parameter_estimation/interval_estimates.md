...
<figure class="notes-img">
  <img src="../../images/conf_1.png" alt="Visualization of the double sided confidence interval on standard normal.">
  <figcaption>Visualization of the double sided confidence interval on standard normal.</figcaption>
</figure>
...
<figure class="notes-img">
  <img src="../../images/conf_2.png" alt="Visualization of the double sided confidence interval on t-distribution.">
  <figcaption>Visualization of the double sided confidence interval on t-distribution.</figcaption>
</figure>
...
since $S_{1}^{2}$ and $S_{2}^{2}$ are independent chi-square random variables and from [section](../distributions/chi_square.md) that the sum of such variables is also chi-square.
