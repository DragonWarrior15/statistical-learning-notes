...
<figure class="notes-img markov_3">
  <img src="../../images/markov_3.png" alt="Sample Markov chain with transient and recurrent states">
  <figcaption>Sample Markov chain with transient and recurrent states</figcaption>
</figure>
