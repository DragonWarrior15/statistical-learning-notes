...
<figure class="notes-img">
  <img src="../../images/hypo_1.png" alt="Acceptance Region for Hypothesis $\mu=\mu_{0}$">
  <figcaption>Acceptance Region for Hypothesis $\mu=\mu_{0}$</figcaption>
</figure>
...
<figure class="notes-img">
  <img src="../../images/pvalue_1.png" alt="*p-value* and significance levels on a standard normal distribution">
  <figcaption>*p-value* and significance levels on a standard normal distribution</figcaption>
</figure>
...
<figure class="notes-img">
  <img src="../../images/hypo_2.png" alt="Curve of $\beta(\mu)$ for a fixed $\alpha$">
  <figcaption>Curve of $\beta(\mu)$ for a fixed $\alpha$</figcaption>
</figure>
