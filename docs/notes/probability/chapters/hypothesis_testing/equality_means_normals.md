...
From [section](../parameter_estimation/interval_estimates.md#estimating-difference-in-means-of-two-normal-populations), we know
...
Using the results derived in [section](mean_normal.md#unknown-variance), we have
...
One sided tests can be derived in exactly the same manner as [section](mean_normal.md#unknown-variance) and the concepts discussed in [section](mean_normal.md#p-value) still hold true.
