...
\begin{aligned}
    ...
    \Gamma_{u} &= \sigma \bigg( [h_{t-1}, x_{t}]W_{u} + b_{u} \bigg)\end{aligned}
$$
...
$$
\begin{aligned}
    h_{t}^{\prime} &= tanh([\Gamma_{r} h_{t-1}, x_{t}]W_{h} + b_{h})\end{aligned}
$$
...
$$
\begin{aligned}
    h_{t} &= \Gamma_{u}h_{t} + (1 - \Gamma_{u})h_{t}^{\prime}\end{aligned}
$$
...
{2}
    ...
    y_{T} &= f_{y}(h_{T}W_{y} + b_{y}) \quad &&\mbox{in case of single output}\end{aligned}
$$
