...
\begin{aligned}
    ...
    y_{t} &= f_{y}(h_{t}W_{yh} + b_{y})\end{aligned}
$$
...
<figure class="notes-img">
  <img src="../../images/rnn_1.png" alt="Diagramatic representation of an RNN. This particular model has $3$ timesteps, input vector has dimension of $4$ and hidden state has dimension of $3$. The output is a single number and this is a many to one type of architecture.">
  <figcaption>Diagramatic representation of an RNN. This particular model has $3$ timesteps, input vector has dimension of $4$ and hidden state has dimension of $3$. The output is a single number and this is a many to one type of architecture.</figcaption>
</figure>
