...
\begin{aligned}
    ...
    a_{l} &= g_{l}(z_{l})\newline
    E[a_{l-1}] &= E[a_{l}]\newline
    Var(a_{l-1}) &= Var(a_{l})\end{aligned}
$$
...
$$
\begin{aligned}
    \frac{dL}{dW} &= X^{T} \frac{dL}{dY} = 0\end{aligned}
$$
...
$$
\begin{aligned}
    w \sim Uniform(-\frac{1}{\sqrt{n}}, \frac{1}{\sqrt{n}})\end{aligned}
$$
...
$$
\begin{aligned}
    a_{l} &= tanh(z_{l}) \approx z_{l} \quad \text{for small $z_{l}$}\end{aligned}
$$
...
$$
\begin{aligned}
    Var(z_{l, k}) &= Var \bigg( \sum_{j=1}^{n_{l-1}} W_{l, kj} a_{l-1, k} + b_{l, k} \bigg)\end{aligned}
$$
...
\begin{aligned}
    ...
    Var(z_{l}) &= \sum_{j=1}^{n_{l-1}} Var(W_{l})Var(a_{l-1}) = n_{l-1}Var(W_{l})Var(a_{l-1})\end{aligned}
$$
...
\begin{aligned}
    ...
    \implies W_{l} &\sim \mathcal{N} \bigg(0, \frac{1}{n_{l-1}} \bigg)\end{aligned}
$$
...
$$
\begin{aligned}
    W_{l} &\sim \mathcal{N} \bigg(0, \frac{2}{n_{l-1} + n_{l}} \bigg)\end{aligned}
$$
...
\begin{aligned}
    ...
    \implies W_{l} &\sim U\bigg(-\sqrt{\frac{6}{n_{l-1} + n_{l}}}, \sqrt{\frac{6}{n_{l-1} + n_{l}}}\bigg)\end{aligned}
$$
...
\begin{aligned}
    ...
    E[a_{l-1}^{2}] &= Var(a_{l-1}) + E[a_{l-1}]^{2} = Var(a_{l-1}) + \frac{1}{4}\end{aligned}
$$
...
\begin{aligned}
    ...
    \implies 16 Var(a_{l}) &= n_{l-1} Var(W_{l}) \bigg(Var(a_{l-1}) + \frac{1}{4} \bigg)\end{aligned}
$$
...
$$
\begin{aligned}
    Var(W_{l}) &= \frac{64}{5 n_{l-1}} = \frac{12.8}{n_{l-1}}\end{aligned}
$$
...
\begin{aligned}
    ...
    W_{l} &\sim \mathcal{N} \bigg(0, \frac{25.6}{n_{l-1} + n_{l}} \bigg)\end{aligned}
$$
...
\begin{aligned}
    ...
    W_{l} &\sim U\bigg(-\sqrt{\frac{76.8}{n_{l-1} + n_{l}}}, \sqrt{\frac{76.8}{n_{l-1} + n_{l}}} \bigg)\end{aligned}
$$
...
\begin{aligned}
    E[a_{l-1}^{2}] &= E[\max(0, z_{l-1})^{2}]\newline
     ...
     &= 0 + E[z_{l-1}^{2}|z_{l-1} > 0]P(z_{l-1} > 0)\end{aligned}
$$
...
\begin{aligned}
    ...
    E[a_{l-1}^{2}] &= \frac{1}{2}Var(z_{l-1})\end{aligned}
$$
...
\begin{aligned}
    ...
    \implies \frac{Var(a_{l})}{Var(a_{l-1})} &= \frac{Var(z_{l})}{Var(z_{l-1})}\end{aligned}
$$
...
\begin{aligned}
    ...
    \implies W_{l} &\sim \mathcal{N}\bigg(0, \frac{2}{n_{l-1}}\bigg)\end{aligned}
$$
...
$$
\begin{aligned}
    W_{l} &\sim \mathcal{N}\bigg(0, \frac{4}{n_{l-1} + n_{l}}\bigg)\end{aligned}
$$
...
$$
\begin{aligned}
    W_{l} &\sim U\bigg(\sqrt{-\frac{12}{n_{l-1} + n_{l}}}, \sqrt{\frac{12}{n_{l-1} + n_{l}}} \bigg)\end{aligned}
$$
...
\begin{aligned}
    ...
    &= E[z_{l-1}^{2}|z_{l-1} > 0]P(z_{l-1} > 0) + E[\alpha^{2} z_{l-1}^{2}|z_{l-1} \leq 0]P(z_{l-1} \leq 0)\end{aligned}
$$
...
\begin{aligned}
    ...
    W_{l} &\sim \mathcal{N}\bigg(0, \frac{2}{n_{l-1}(1 + \alpha^{2})}\bigg)\end{aligned}
$$
...
$$
\begin{aligned}
    W_{l} &\sim \mathcal{N}\bigg(0, \frac{4}{(n_{l-1} + n_{l})(1 + \alpha^{2})}\bigg)\end{aligned}
$$
...
\begin{aligned}
    ...
    \implies W_{l} &\sim U\bigg(-\sqrt{\frac{24}{(n_{l-1} + n_{l})(1+ \alpha^{2})}}, \sqrt{\frac{24}{(n_{l-1} + n_{l})(1+ \alpha^{2})}}\bigg)\end{aligned}
$$
