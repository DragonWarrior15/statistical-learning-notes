...
\begin{aligned}
    Y &= XW + b\newline
    X &\in \mathbb{R}^{N \times p}, W \in \mathbb{R}^{p \times k}, Y \in \mathbb{R}^{N \times k}, b \in \mathbb{R}^{k}\end{aligned}
$$
...
\begin{aligned}
    ...
    \frac{dL}{dW_{ij}} &= \sum_{l=1}^{N} \frac{dL}{dY_{lj}} \frac{dY_{lj}}{dW_{ij}}\end{aligned}
$$
...
\begin{aligned}
    ...
    \frac{dL}{dW} &= X^{T} \frac{dL}{dY}\end{aligned}
$$
...
\begin{aligned}
    ...
    \frac{dL}{dX_{ij}} &= \sum_{l=1}^{k} \frac{dL}{dY_{il}} \frac{dY_{il}}{dX_{ij}}\end{aligned}
$$
...
\begin{aligned}
    ...
    \implies \frac{dL}{dX} &= \frac{dL}{dY} W^{T}\end{aligned}
$$
...
\begin{aligned}
    ...
    \frac{dL}{db_{i}} &= \sum_{l=1}^{N} \frac{dL}{dY_{li}} \frac{dY_{li}}{db}\end{aligned}
$$
...
\begin{aligned}
    ...
    \frac{dL}{db} &= \boldsymbol{1}\_{N}^{T}\frac{dL}{dY}\end{aligned}
$$
...
$$
\begin{aligned}
    (N \times h_{i} \times w_{i} \times c_{i}) * (f_{1} \times f_{2} \times c_{i} \times c_{o}) \rightarrow (N \times h_{o} \times w_{o} \times c_{o})\end{aligned}
$$
...
\begin{aligned}
    ...
    \frac{dY_{ij}}{dF_{kl}} &= X_{(i+k-1)(j+l-1)}\end{aligned}
$$
...
\begin{aligned}
    ...
    \implies \frac{dL}{dF} &= X * \frac{dL}{dY}\end{aligned}
$$
...
\begin{aligned}
    ...
    &= \boldsymbol{1}\_{h+f_{1}-1}\frac{dL}{dY}\boldsymbol{1}\_{w+f_{2}-1}\end{aligned}
$$
...
<figure class="notes-img">
  <img src="../../images/gradient_conv_1.png" alt="The black box represents $X$, while the red, green, purple and sky blue boxes represent the four extreme filters that will contain $X_{ij}$ as a part of their calculation. In all these four filters, $X_{ij}$ will occupy one corner of the filter.">
  <figcaption>The black box represents $X$, while the red, green, purple and sky blue boxes represent the four extreme filters that will contain $X_{ij}$ as a part of their calculation. In all these four filters, $X_{ij}$ will occupy one corner of the filter.</figcaption>
</figure>
...
\begin{aligned}
    ...
    = \frac{dL}{dY_{(i-f_{1}+1:i)(j-f_{2}+1:j)}} * F^{flip}\end{aligned}
$$
...
\begin{aligned}
    ...
    \frac{dL}{dY^{pad}} &\in \mathbb{R}^{((h-f_{1}+1)+2(f_{1}-1) \times (w-f_{2}+1) + 2(f_{2}-1)} \sim \mathbb{R}^{(h+f_{1}-1) \times (w+f_{2}-1)}\end{aligned}
$$
...
\begin{aligned}
    ...
    \frac{dL}{dX} &= \frac{dL}{dY^{pad}} * F^{flip}\end{aligned}
$$
