...
<figure class="notes-img">
  <img src="../../images/gradient_backprop_example_1.png" alt="Top figure shows a time series, with the sample ACF and sample PACFs shown by middle and bottom figures respectively. Due to the symmetric nature, most packages only plot ACF for positive lags. Plot prepared using backprop_example_1.py">
  <figcaption>Top figure shows a time series, with the sample ACF and sample PACFs shown by middle and bottom figures respectively. Due to the symmetric nature, most packages only plot ACF for positive lags. Plot prepared using <a href="../../codes/backprop_example_1.md">backprop_example_1.py</a></figcaption>
</figure>
