...
$$
\begin{aligned}
    L = -(ylog(\hat{y}) + (1-y)log(1-\hat{y})\end{aligned}
$$
...
\begin{aligned}
    ...
    &= -(\frac{y}{\hat{y}} - \frac{1-y}{1 - \hat{y}})\end{aligned}
$$
...
$$
\begin{aligned}
    L = -\frac{1}{N} \big( y^{T}log(\hat{y}) + (1-y)^{T}log(1-\hat{y})) \big)\end{aligned}
$$
...
\begin{aligned}
    ...
    \frac{dL}{d\hat{y}} &= -\frac{1}{N} \big( \frac{y}{\hat{y}} - \frac{1-y}{1-\hat{y}} \big)\end{aligned}
$$
...
$$
\begin{aligned}
    L = -\sum_{i=1}^{k}y_{i}log(\hat{y}\_{i})\end{aligned}
$$
...
\begin{aligned}
    ...
    = -\bigg(\frac{y}{\hat{y}} \bigg)\end{aligned}
$$
...
$$
\begin{aligned}
    L = -\frac{1}{N} \sum_{i=1}^{N} \sum_{j=1}^{k} y_{ij}log(\hat{y}\_{ij})\end{aligned}
$$
...
\begin{aligned}
    ...
    \frac{dL}{d\hat{y}} &= -\frac{1}{N} \frac{y}{\hat{y}}\end{aligned}
$$
