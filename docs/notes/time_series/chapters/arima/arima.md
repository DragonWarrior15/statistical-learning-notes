...
<figure class="notes-img">
  <img src="../../images/arima_1.png" alt="Top figure shows an ARIMA(2,1,2) time series, which is clearly non stationary as the covariance varies wildly. Bottom plot shows the differenced series which is stationary. Figures plot using arima_simulation.py">
  <figcaption>Top figure shows an ARIMA(2,1,2) time series, which is clearly non stationary as the covariance varies wildly. Bottom plot shows the differenced series which is stationary. Figures plot using <a href="../../codes/arima_simulation.md">arima_simulation.py</a></figcaption>
</figure>
...
\begin{aligned}
    ...
    &H_{1}: \text{at least one correlation between different lags is non zero}\end{aligned}
$$
...
$$
\begin{aligned}
    Q = n(n+2) \sum_{k=1}^{h}\frac{\hat{\rho}\_{k}}{n-k}\end{aligned}
$$
...
$$
\begin{aligned}
    \text{Accept $H_{0}$ if } \quad Q < \chi_{1-\alpha, h}^{2}\end{aligned}
$$
...
\begin{aligned}
    ...
    X_{t} &= \Phi_{1}X_{t-s} + \cdots \Phi_{p}X_{t-sp} + W_{t} + \mathcal{B}\_{1}W_{t-s} + \cdots + \mathcal{B}\_{q}W_{t-sq}\end{aligned}
$$
...
\begin{aligned}
    ...
    X_{t} &= \Phi_{1}X_{t-12} + \Phi_{2}X_{t-24} + W_{t} + \mathcal{B}\_{1}W_{t-12}\end{aligned}
$$
...
\begin{aligned}
    ...
    (1 - \Phi_{1}B^{12} - \Phi_{2}B^{24})(1 - \phi_{1}B)X_{t} &= (1 + \mathcal{B}\_{1}B^{12})(1 + \beta_{1}B)W_{t}\end{aligned}
$$
...
\begin{aligned}
    ...
    \beta(B) &= 1 + \beta_{1}B + \beta_{2}B^{2} + \cdots + \beta_{q}B^{q}\end{aligned}
$$
