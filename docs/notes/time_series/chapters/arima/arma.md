...
$$
\begin{aligned}
    X_{t} = \phi_{1}X_{t-1} + \cdots + \phi_{p}X_{t-p} + W_{t} + \beta_{1}W_{t-1} + \cdots \beta_{q}W_{t-q}\end{aligned}
$$
...
\begin{aligned}
    ...
    \phi(B)X_{t} &= \beta(B)W_{t}\end{aligned}
$$
...
\begin{aligned}
    ...
    X_{t} &= W_{t}\newline
    (1-B)X_{t} &= (1-B)W_{t}\newline
    X_{t} &= X_{t-1} + W_{t} - W_{t-1}\end{aligned}
$$
...
$$
\begin{aligned}
    \psi(z) = \frac{\beta(z)}{\phi(z)} \quad \lvert z \rvert \leq 1\end{aligned}
$$
...
$$
\begin{aligned}
    \phi(z) \neq 0 \quad \forall \; \lvert z \rvert \leq 1\end{aligned}
$$
...
\begin{aligned}
    ...
    \pi_{0} = 1 \quad \sum_{i=0}^{\infty} \lvert \pi_{i} \rvert &< \infty \quad \pi(B) = \sum_{i=0}^{\infty} \pi_{i}B^{i}\end{aligned}
$$
...
\begin{aligned}
    ...
    \implies &\text{roots of $\beta(z)$ lie outside the unit circle}\end{aligned}
$$
