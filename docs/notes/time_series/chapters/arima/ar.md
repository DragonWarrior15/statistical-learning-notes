...
$$
\begin{aligned}
    \phi(B) = 1 - \phi_{1}B - \phi_{2}B^{2} - \cdots - \phi_{p}B^{p}\end{aligned}
$$
...
\begin{aligned}
    ...
    &= \sum_{i=0}^{\infty}\phi_{1}^{i}W_{t-i}\end{aligned}
$$
...
$$
\begin{aligned}
    \lim_{n \to \infty} E[(X_{n} - X)^{2}] = 0\end{aligned}
$$
...
$$
\begin{aligned}
    \lim_{k \to \infty} E[(X_{t} - \sum_{j=0}^{k-1}\phi_{1}^{i}W_{t-i})^{2}] = \lim_{k \to \infty} E[(\phi^{k} X_{t-k})^{2}] = 0\end{aligned}
$$
...
\begin{aligned}
    ...
    \implies \phi(z) &\neq 0 \; \forall \; \lvert z \rvert \leq 1\end{aligned}
$$
...
\begin{aligned}
    ...
    &= \sum_{i=0}^{\infty}\phi_{1}^{-(i+1)}W_{t+i}\end{aligned}
$$
...
\begin{aligned}
    ...
    &= \frac{\sigma_{w}^{2} \phi_{1}^{h}}{1-\phi_{1}^{2}} \quad h \geq 0\end{aligned}
$$
...
$$
\begin{aligned}
    X_{t} &= \sum_{i=0}^{\infty}\psi_{j}W_{t-i}\end{aligned}
$$
...
$$
\begin{aligned}
    \hat{\sigma}^{2} = \hat{\gamma}(0)\bigg(1 - \sum_{k=1}^{p}\phi_{k}^{2} - 2\sum_{i=1}^{p-1}\sum_{j=i+1}^{p} \phi_{i}\phi_{j}\hat{\rho}(j - i)\bigg)\end{aligned}
$$
