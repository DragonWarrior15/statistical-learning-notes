...
\begin{aligned}
    ...
    \text{with} \; \sum_{i=-k}^{k}a_{i} &= 1\end{aligned}
$$
...
\begin{aligned}
    ...
    K(z) &= \frac{1}{\sqrt{2\pi\sigma^{2}}}exp(-\frac{1}{2\sigma^{2}}z^{2}) \; \text{for gaussian kernel}\end{aligned}
$$
...
$$
\begin{aligned}
    M_{t} = \beta_{0} + \beta_{1}t + \beta_{2}t^{2} + \beta_{3}t^{3}\end{aligned}
$$
