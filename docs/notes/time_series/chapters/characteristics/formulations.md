...
$$
\begin{aligned}
    v_{t} = \frac{1}{3}(x_{t-1} + x_{t} + x_{t+1})\end{aligned}
$$
...
$$
\begin{aligned}
    x_{t} = x_{t-1} + 0.9x_{t-2} + w_{t}\end{aligned}
$$
...
\begin{aligned}
    ...
    x_{t} &= \delta t + \sum_{t} w_{t}\end{aligned}
$$
...
$$
\begin{aligned}
    x_{t} = A\cos (2\pi \omega t + \phi) + w_{t}\end{aligned}
$$
