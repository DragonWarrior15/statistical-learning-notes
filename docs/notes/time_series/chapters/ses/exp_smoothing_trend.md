...
\begin{aligned}
    ...
    b_{t} &= \beta(l_{t} - l_{t-1}) + (1-\beta)b_{t-1}\end{aligned}
$$
...
\begin{aligned}
    ...
    b_{t} &= \beta(l_{t} - l_{t-1}) + (1-\beta)\phi b_{t-1}    \end{aligned}
$$
