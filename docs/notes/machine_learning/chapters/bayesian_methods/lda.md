...
<figure class="notes-img">
  <img src="../../images/lda_1.png" alt="Generative Model for LDA (N is fixed in the box for simplicity, but will vary across documents)">
  <figcaption>Generative Model for LDA (\(N\) is fixed in the box for simplicity, but will vary across documents)</figcaption>
</figure>
