...
$$
\begin{aligned}
    \hat{\theta}\_{MLE} = \max_{\theta}p(X|\theta)\end{aligned}
$$
...
\begin{aligned}
    ...
    \hat{\mu}\_{MLE} &= \frac{1}{N}\sum_{i=1}^{N} x_{i}\end{aligned}
$$
...
\begin{aligned}
    ...
    \text{Informtion Matrix} \quad \mathbf{I}(\theta) &= -\sum_{i=1}^{N} \frac{\partial^{2}l(\theta;x_{i})}{\partial \theta \partial \theta^{T}}\end{aligned}
$$
...
$$
\begin{aligned}
    \mathbf{i}(\theta) = E_{\theta}[\mathbf{I}(\theta)]\end{aligned}
$$
...
$$
\begin{aligned}
    \hat{\theta} \sim \mathcal{N}(\theta_{0}, \mathbf{I}^{-1}(\theta_{0})) = \mathcal{N}(\theta_{0}, \mathbf{i}^{-1}(\theta_{0}))\end{aligned}
$$
...
\begin{aligned}
    ...
    \text{or,} \quad \theta_{0,j} \in \hat{\theta}\_{j} \pm \mathbf{I}^{-1}(\hat{\theta}\_{j})z_{\alpha/2}\end{aligned}
$$
...
$$
\begin{aligned}
    2(l(\hat{\theta}) - l(\theta_{0})) \sim \chi^{2}\_{p}\end{aligned}
$$
