...
$$
\begin{aligned}
    p(z|X) \approx \min_{q \in Q} \KL{q(z)}{p(z|X)}\end{aligned}
$$
...
\begin{aligned}
    ...
    p(z|X) &\approx \min_{q \in Q} \KL{q(z)}{p(X|z)p(z)} \quad (p(X|z)p(z) = p^{*}(z))\end{aligned}
$$
...
$$
\begin{aligned}
    q(z) = p(z|x, \theta) \approx \min_{q \in Q}KL{q(z)}{p^{*}(z)}\end{aligned}
$$
...
\begin{aligned}
    ...
    q(z) = \argmin_{q \in Q} \KL{\prod_{i=1}^{d}q_{i}(z_{i})}{p^{*}(z)}\end{aligned}
$$
