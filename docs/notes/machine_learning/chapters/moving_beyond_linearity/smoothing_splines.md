...
In some sense, this is similar to the [natural splines](regression_splines.md) but is a shrinked version of the same, $\lambda$ controlling the level of shrinkage (or how large the roughness can be).
