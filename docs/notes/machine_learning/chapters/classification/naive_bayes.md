...
$$
\begin{aligned}
    P(Y \vert X) = \frac{P(X \vert Y)P(Y)}{P(X)}\end{aligned}
$$
...
$$
\begin{aligned}
    P(Y \vert X) = \frac{\bigg( \prod_{i=1}^{p} P(X_{i} \vert Y) \bigg) P(Y)}{P(X)}\end{aligned}
$$
...
1 &= P(Y=1 \vert X) + P(Y=0 \vert X)\end{aligned}
$$
...
$$
\begin{aligned}
     P(X_{i} = x_{i}  \vert  Y=y) = \frac{1}{\sqrt{2\pi \sigma_{y}^{2}}}exp(-\frac{(x_{i} - \mu_{y})^{2}}{2\sigma_{y}^{2}})\end{aligned}
$$
...
$$
\begin{aligned}
    P(Y \vert D) = \frac{P(D \vert Y)P(Y)}{P(D)} = \frac{1}{P(D)} P(Y) \prod_{i=1}^{N} P(w_{i} \vert Y)\end{aligned}
$$
...
$$
\begin{aligned}
    P(w_{i} \vert Y=y) = \frac{\text{count of appearances of word $w_{i}$ in documents with sentiment $y$}}{\text{Total words in the documents with sentiment $y$}}\end{aligned}
$$
...
$$
\begin{aligned}
    P(w_{i} \vert Y=y) = \frac{\text{count of appearances of word $w_{i}$ in documents with sentiment $y$} + 1}{\text{Total words in the documents with sentiment $y$}+V}\end{aligned}
$$
...
\begin{aligned}
    ...
    \text{or, }\; log(P(Y=1 \vert D)) - log(P(Y=0 \vert D)) &= \big[ log(P(Y=1)) - log(P(Y=0)) \big] \newline &+ \big [ \sum_{i=1}^{N}log(P(w_{i} \vert Y=1)) - \sum_{i=1}^{N}log(P(w_{i} \vert Y=0)) \big]\end{aligned}
$$
