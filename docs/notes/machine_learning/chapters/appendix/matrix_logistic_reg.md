...
The equations below present the extended version of the matrix calculus in [Logistic Regression](../classification/logistic.md#loss-function)
...
{1}
    ...
    &= \sum_{i=1}^{n} x_{i}(y_{i} - p(x_{i}))\end{aligned}
$$
...
\begin{aligned}
    ...
    &= p(x_{i})(1-p(x_{i}))x_{i,j}\end{aligned}
$$
...
\begin{aligned}
    ...
    \end{bmatrix}\newline
    &= \sum_{i=1}^{n} p(x_{i})(1-p(x_{i})) x_{i}x_{i}^{T}\end{aligned}
$$
