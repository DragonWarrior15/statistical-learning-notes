...
$$
\begin{aligned}
    d^{2} = \sum_{i=1}^{p} (x_{i} - x_{ai})^{2}\end{aligned}
$$
...
$$
\begin{aligned}
    \minimize_{x_{a1}, \ldots, x_{ap}} \sum_{i=1}^{p} (x_{i} - x_{ai})^{2} + \lambda (\beta_{0} + \beta_{1}x_{a1} + \cdots + \beta_{p}x_{ap})\end{aligned}
$$
...
\begin{aligned}
    ...
    \text{or} \quad \frac{(\beta_{0} + \sum_{i=1}^{p} \beta_{i}x_{i})^{2}}{\sum_{i=1}^{p}\beta_{i}^{2}} &= d^{2}\end{aligned}
$$
