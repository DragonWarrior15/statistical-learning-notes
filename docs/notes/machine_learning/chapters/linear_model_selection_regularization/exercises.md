...
3.  1.  Refer to [image](shrinkage.md#variable-selection-property-of-lasso-regression). As we increase s, we are expanding the region of allowed $\beta$. Hence, we are moving closer to the least squares fit which gives minimum training RSS.
