...
<figure class="notes-img">
  <img src="../../images/lasso_contours.png" alt="For p=2, the left and right images correspond to Lasso and Ridge Regression.">
  <figcaption>For \(p=2\), the left and right images correspond to Lasso and Ridge Regression.</figcaption>
</figure>
...
<figure class="notes-img">
  <img src="../../images/lasso_bayes.png" alt="Gaussian prior on left and double exponential on the right">
  <figcaption>Gaussian prior on left and double exponential on the right</figcaption>
</figure>
...
<figure class="notes-img">
  <img src="../../images/elastic_net.png" alt="Contours of \sum_{p} \mid \beta_{j} \mid^{q} in case of (a) Ridge (q=2) (b) q=1.2 (c) Elastic Net (\alpha=0.2) (d) Lasso q=1">
  <figcaption>Contours of \(\sum_{p} \mid \beta_{j} \mid^{q}\) in case of (a) Ridge (\(q=2\)) (b) \(q=1.2\) (c) Elastic Net (\(\alpha=0.2\)) (d) Lasso \(q=1\)</figcaption>
</figure>
