...
<figure class="notes-img">
  <img src="../../images/mmc.png" alt="The Maximal Margin Classifier with the Support Vectors. Dotted lines represent the margin.">
  <figcaption>The Maximal Margin Classifier with the Support Vectors. Dotted lines represent the margin.</figcaption>
</figure>
...
By using the perpendicular distance using the equation from [appendix](../appendix/perp_mmc.md), we can replace the constraint on the norm and rewrite as
...
For the following derivations involving linear optimization, refer to [appendix](../appendix/lagrangian.md).
