...
<figure class="notes-img">
  <img src="../../images/dendogram.png" alt="Visualization of dendogram. The two curves on the right colour the different clusters obtained based on the height at which we decide to cut.">
  <figcaption>Visualization of dendogram. The two curves on the right colour the different clusters obtained based on the height at which we decide to cut.</figcaption>
</figure>
...
<figure class="notes-img">
  <img src="../../images/dendogram_linkages.png" alt="Visualization of dendograms obtained for different choice of linkages.">
  <figcaption>Visualization of dendograms obtained for different choice of linkages.</figcaption>
</figure>
