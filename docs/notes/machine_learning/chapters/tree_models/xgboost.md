...
$$
\begin{aligned}
     obj(\theta) = L(\theta) + \Omega(\theta)\end{aligned}
$$
...
$$
\begin{aligned}
    \hat{y}\_{i} = \sum_{t=1}^{T} f_{t}(x_{i})\end{aligned}
$$
...
$$
\begin{aligned}
    obj(\theta) = \sum_{i=1}^{N} l(y_{i}, \hat{y}\_{i}) + \sum_{t=1}^{T} \Omega(f_{t})\end{aligned}
$$
...
\begin{aligned}
    ...
    &= \hat{y}\_{i}^{(t-1)} + f_{t}(x_{i})\end{aligned}
$$
...
\begin{aligned}
    ...
    &= \sum_{i=1}^{N} l(y_{i}, \hat{y}^{(t-1)}\_{i} + f_{t}(x_{i})) + \Omega(f_{t}) + constant\end{aligned}
$$
...
$$
\begin{aligned}
    f(x) = f(a) + \frac{f^{\prime}(a)}{1!}(x-a) + \frac{f^{\prime \prime}(a)}{2!}(x-a)^{2} + \ldots\end{aligned}
$$
...
$$
\begin{aligned}
    obj^{(t)} &= \sum_{i=1}^{N} g_{i} f_{t}(x_{i}) + \frac{1}{2} h_{i} f_{t}^{2}(x_{i}) + \Omega(f_{t}) + constant\end{aligned}
$$
...
\begin{aligned}
    ...
    &= \sum_{j=1}^{L} (\sum_{i \in I_{j}} g_{i})w_{j} + \frac{1}{2}(\sum_{i \in I_{j}} h_{i})w^{2}\_{j} + \Omega(f_{t})\end{aligned}
$$
...
$$
\begin{aligned}
    \Omega(f_{t}) = \gamma L + \frac{1}{2}\lambda \sum_{j=1}^{L} w_{j}^{2}\end{aligned}
$$
...
\begin{aligned}
    ...
    &= \sum_{j=1}^{L} (\sum_{i \in I_{j}} g_{i})w_{j} + \frac{1}{2}(\sum_{i \in I_{j}} h_{i})w^{2}\_{j} + \frac{1}{2}\lambda w_{i}^{2} + \gamma L\end{aligned}
$$
...
\begin{aligned}
    ...
    H_{j} &= \sum_{i \in I_{j}} h_{i}\end{aligned}
$$
...
$$
\begin{aligned}
    w^{\ast}\_{j} = -\frac{G_{j}}{H_{j} + \lambda}\end{aligned}
$$
...
\begin{aligned}
    ...
    &= \sum_{j=1}^{L} -\frac{1}{2}\frac{G^{2}\_{j}}{H_{j} + \lambda} + \gamma L\end{aligned}
$$
...
\begin{aligned}
    ...
    &= \frac{1}{2} \bigg[ \frac{G_{Left}^{2}}{H_{Left} + \lambda} + \frac{G_{Right}}{H_{Right} + \lambda} - \frac{(G_{Left} + G_{Right})^{2}}{(H_{Left} + H_{Right}) + \lambda} \bigg] -\gamma\end{aligned}
$$
