...
{1}
    ...
    &= (X^{T}X)^{-1}X^{T}\sigma^{2}\newline
    \hat{\beta} &\sim \mathcal{N}(\beta, (X^{T}X)^{-1}\sigma^{2})\end{aligned}
$$
...
$$
\begin{aligned}
    \hat{\sigma}^{2} = \frac{1}{n-p-1} \sum_{i=1}^{n} (y_{i} - \hat{y}\_{i})^{2} \text{,}\quad E[\hat{\sigma}^{2}] = \sigma^{2}\end{aligned}
$$
...
$$
\begin{aligned}
    (n - p - 1) \frac{\hat{\sigma}^{2}}{\sigma^{2}} \sim \chi_{n-p-1}^{2}\end{aligned}
$$
...
\begin{aligned}
    ...
    x^{T}\hat{\beta} &\sim \mathcal{N}(x^{T}\beta, x^{T}(X^{T}X)^{-1}x \sigma^{2})\end{aligned}
$$
...
$$
\begin{aligned}
    \beta_{j} \in \hat{\beta} \pm \hat{\sigma} t_{\alpha/2, n-p-1} \sqrt{diag((X^{T}X)^{-1})\_{j}}\end{aligned}
$$
...
\begin{aligned}
    ...
    \text{Minimizing,} \quad \hat{\beta} = (X_{T}X)^{-1}X^{T}Y \quad \text{where $Y$ is a $n \times k$ matrix}\end{aligned}
$$
...
$$
\begin{aligned}
    y = \beta_{0} + \beta_{1}X_{1} + \beta_{2}X_{2} + \ldots + \beta_{p}X_{p} + \epsilon\end{aligned}
$$
...
$$
\begin{aligned}
    y = \beta_{income}+x_{income} + \beta_{student}x_{student} + \epsilon\end{aligned}
$$
...
$$
\begin{aligned}
    y = \beta_{income}+x_{income} + \beta_{student}x_{student} + \beta_{income \times student}x_{income}x_{student} + \epsilon\end{aligned}
$$
