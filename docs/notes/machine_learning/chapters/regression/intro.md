...
\begin{aligned}
    ...
    Y &= \beta_{0} + \beta_{1}X_{1} + \beta_{2}X_{2} + \cdots + \beta_{p}X_{p} + \epsilon\end{aligned}
$$
...
$$
\begin{aligned}
    \hat{Y} &= \hat{\beta}\_{0} + \hat{\beta}\_{1}X_{1} + \hat{\beta}\_{2}X_{2} + \cdots + \hat{\beta}\_{p}X_{p} + \epsilon\end{aligned}
$$
