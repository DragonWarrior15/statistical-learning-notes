...
$$
\begin{aligned}
    U_{1} + U_{2} + \cdots + U_{m} = \{u_{1} + u_{2} + \cdots + u_{m} | u_{1} \in U_{1}, u_{2} \in U_{2}, \ldots, u_{m} \in U_{m} \}\end{aligned}
$$
...
$$
\begin{aligned}
    U_{1} + U_{2} + \cdots + U_{m} = U_{1} \oplus U_{2} \oplus \cdots \oplus U_{m}\end{aligned}
$$
...
$$
\begin{aligned}
    U_{1} \oplus U_{2} \oplus \cdots \oplus U_{m} = u_{1} + u_{2} + \cdots + u_{m}\end{aligned}
$$
...
\begin{aligned}
    ...
    \text{Then,} \: \field^{3} &= U_{1} \oplus U_{2}\end{aligned}
$$
