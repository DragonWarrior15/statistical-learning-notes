...
$$
\begin{aligned}
    V_{1}\times \cdots \times V_{m} = \{ (v_{1}, \ldots, v_{m}) \: v_{1}\in V_{1}, \ldots v_{m} \in V_{m} \}\end{aligned}
$$
...
\begin{aligned}
    ...
    \lambda (v_{1}, \ldots, v_{m}) &= (\lambda v_{1}, \ldots, \lambda v_{m})\end{aligned}
$$
...
$$
\begin{aligned}
    \text{dim}(V_{1} \times \cdots \times V_{m}) = \text{dim }V_{1} + \cdots + \text{ dim }V_{m}\end{aligned}
$$
...
\begin{aligned}
    ...
    \text{dim } \setv/U &= \text{ dim } \setv - \text{ dim } U\end{aligned}
$$
...
\begin{aligned}
    (v + U) + (w + U) &= (v + w) + U\newline
    \lambda(v + U) &= (\lambda v) + U\end{aligned}
$$
