...
### Fields
A field $\field$ can either be $\comp$ or $\real$. A field is a set of atleast two distinct elements $\{0, 1\}$ satisfying all the properties laid out [here](https://dragonwarrior15.github.io/statistical-learning-notes/) along with addition and multiplication defined.
